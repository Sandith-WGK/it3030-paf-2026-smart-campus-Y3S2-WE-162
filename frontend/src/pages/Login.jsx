...
const Login = () => {
  ...
  const handleStandardLogin = (e) => {
    e.preventDefault();
    setIsLoading(true);
    // Standard login can be connected here later.
    // For now, it simulates a loading state before rejecting, prompting the Google login.
    setTimeout(() => {
      setIsLoading(false);
      alert("Local login is currently disabled. Please use 'Continue with Google'.");
    }, 800);
  };
          ...
          <form className="space-y-5" onSubmit={handleStandardLogin}>
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <a href="#" className="text-xs font-medium text-violet-600 hover:text-violet-500 dark:text-violet-400">
                  Forgot password?
                </a>
              </div>
              <input
